...
- [ ] **Улучшения редактора и локализация**
    ...
    - [ ] Перевод названий жанров на русский/английский язык
    - [ ] Синхронизация перевода жанров с выбранным языком интерфейса
    - Definition of Done: Жанры полностью локализованы и работает их выбор/фильтрация
