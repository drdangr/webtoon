...
**🎯 ЦЕЛЬ ДНЯ:** Исправить доступ к содержимому публичных комиксов для не‑авторов (RLS), упростить модель публикации, улучшить UX (центрирование, сохранение позиции, зум, уведомление о подтверждении почты).
...
### 📅 День 5. 9 августа 2025 🎯 **Финализация лайков и просмотров (синхронизация с БД)**

**🎯 ЦЕЛЬ ДНЯ:** Починить некорректные счётчики (лайки уходили в −1, просмотры не сохранялись) и гарантировать корректную синхронизацию UI ⇄ БД.
